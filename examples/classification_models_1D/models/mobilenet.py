...
def _depthwise_conv_block(
    ...
    # Arguments
        ...
        pointwise_conv_filters: Integer, the dimensionality of the outputs space
            (i.e. the number of outputs filters in the pointwise convolution).
        alpha: controls the width of the network.
            - If `alpha` < 1.0, proportionally decreases the number
                of filters in each layer.
            - If `alpha` > 1.0, proportionally increases the number
            ...
            - If `alpha` = 1, default number of filters from the paper
                 are used at each layer.
        depth_multiplier: The number of depthwise convolution outputs channels
            for each input channel.
            The total number of depthwise convolution outputs
