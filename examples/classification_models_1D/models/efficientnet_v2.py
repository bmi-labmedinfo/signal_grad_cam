...
"""EfficientNet V2 1D models for Keras.
    ...
    **kwargs
    ...
    """Instantiates the EfficientNetV2 architecture using given scaling coefficients.
      ...
      Args:
        ...
        input_tensor: optional Keras tensor (i.e. outputs of `layers.Input()`) or
        ...
        pooling: optional pooling mode for feature extraction when `include_top` is
          `False`. - `None` means that the outputs of the model will be the 4D tensor
          outputs of the last convolutional layer. - "avg" means that global average
          pooling will be applied to the outputs of the last convolutional layer, and
          thus the outputs of the model will be a 2D tensor. - `"max"` means that
    ...
    for (i, args) in enumerate(blocks_args):
        ...
        # Update block input and outputs filters based on depth multiplier.
